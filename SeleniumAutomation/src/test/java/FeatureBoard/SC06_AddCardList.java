...
public class SC06_AddCardList {
    ...
    @Test
    public void TC01_AddCardSuccess() throws InterruptedException {
        ...
        Thread.sleep(2000);
        //Input Card Name
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/div[2]/div/div[1]/div/div/div[4]/div[1]/form/input")).sendKeys("Login");
        Thread.sleep(2000);
        //Click Button Add Card
        ...
        assertTrue(actualString.contains("Creating card is success"));
    }

    @Test
    public void TC02_AddCardWithoutdata() throws InterruptedException {
        driver.get("https://staging.cicle.app/signin");
        WebDriverWait wait = new WebDriverWait(driver, 3);
        //Click Menu Soal Paket C
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div[4]/a/div/h1")).click();
        ...
        //Validasi PopUp
        String actualString = driver.findElement(By.id("notistack-snackbar")).getText();
        assertTrue(actualString.contains("Card name cannot be empty"));
    }

    @Test
    public void TC03_CloseAddCard() throws InterruptedException {
        driver.get("https://staging.cicle.app/signin");
        WebDriverWait wait = new WebDriverWait(driver, 3);
        //Click Menu Soal Paket C
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div[4]/a/div/h1")).click();
        ...
        driver.findElement(By.cssSelector(".CreateCardForm_actionSection__7iFql > svg:nth-child(2)")).click();
        Thread.sleep(2000);
