...
public class SC03_ButtonMenuPaketSoalC {
    WebDriver driver;
    ...
    @Test
    public void TC01_FuncButtonMenuPaketSoalC() throws InterruptedException {
        ...
        Thread.sleep(2000);
        //Click Button Menu Soal Paket C
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/nav/ol/li[3]/a/span")).click();
        Thread.sleep(2000);
        //Validasi Text
