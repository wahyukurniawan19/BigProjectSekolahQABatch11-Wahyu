...
public class SC07_MoveCard {
    ...
    @Test
    public void TC01_MoveCardInList1toList2() throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebElement a = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/div[2]/div/div[1]/div/div/div[3]/div/div/div/div/div[1]/div[1]/div/div/a"));
        WebElement b = driver.findElement(By.id("listcard_content-1"));
    ...
    @Test
    public void TC02_MoveBackCardInList1toList2() throws InterruptedException {
        driver.get("https://staging.cicle.app/signin");
        WebDriverWait wait = new WebDriverWait(driver, 3);
        //Click Menu Soal Paket C
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div[4]/a/div/h1")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div/div[3]/div[4]/a/div/div/div[1]")).click();
        Thread.sleep(2000);
        WebElement a = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/div[2]/div/div[2]/div/div/div[3]/div/div/div/div/div[1]/div/div/div/a"));
        WebElement b = driver.findElement(By.id("listcard_content-0"));
